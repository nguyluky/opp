...
public class OptionQuanLyDuAn extends ScreenOption {
    ...
    public class ThemDuAn extends Screen {
        public void show(Display display) {
            Scanner sc = display.sc;
            ...
            while (true) {
                ...
                if (QuanLyDuAn.getInstance().getDuAnByName(nameDuAn) != null) {
            ...
            String idDuAn;
            while (true) {
                System.out.print("Nhập ID dự án thứ: ");
                idDuAn = sc.nextLine();
                if (QuanLyDuAn.getInstance().getDuAnById(idDuAn) != null) {
            ...
            int choice = this.getChoice(sc, 0, 2);
            switch (choice) {
                case 1:
            ...
            QuanLyDuAn.getInstance().addDuAn(currentDuAn);
